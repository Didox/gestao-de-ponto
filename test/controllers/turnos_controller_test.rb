...
class TurnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post turnos_url, params: { turno: { entrada: @turno.entrada, funcionario_id: @turno.funcionario_id, saida: @turno.saida } }
    end
  ...
  test "should update turno" do
    patch turno_url(@turno), params: { turno: { entrada: @turno.entrada, funcionario_id: @turno.funcionario_id, saida: @turno.saida } }
